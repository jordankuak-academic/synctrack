    ...
    */
    ...
    "options" => [
        ...
        "views" => [
            ...
            "group" => (int) env("DEBUGBAR_OPTIONS_VIEWS_GROUP", 50),                    // Group duplicate views. Pass value to auto-group, or true/false to force grouping
            "exclude_paths" => [    // Add the paths which you don't want to appear in the views collector
